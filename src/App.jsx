...
const AttendancePopup = ({ onClose, participants, locations }) => {
                ...
                <div className="popup-wrapper popup-wrapper-visible bg-gray-800 p-6 rounded-xl shadow-neumorphic w-full max-w-2xl border-2 border-green-500 flex flex-col" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="border-t border-gray-600 mt-4 pt-4">
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
                             <button onClick={() => openModal('participantAttendanceReportDateRange', { onFetch: handleFetchParticipantReport, locations })} className="px-6 py-2 bg-gray-700 font-bold rounded-lg hover:bg-gray-600 w-full sm:w-auto">
        ...
        <div ref={navMenuRef} className="relative">
            ...
            {isNavMenuOpen && (
                <div className="absolute top-full right-0 mt-2 w-64 bg-gray-700 rounded-lg shadow-lg z-20 border border-gray-600 p-2 space-y-1">
                   ...
                   {currentUser?.permissions?.daftarHadir && <button onClick={() => handleMenuClick(() => openModal('attendance', { participants: attendanceParticipants, locations: allFilterOptions.tc }))} className="w-full text-left px-4 py-2 rounded-md font-semibold text-white bg-emerald-500 hover:bg-emerald-600">Daftar Hadir Peserta</button>}
